      ...
      <section className="bg-[#FDFBF2] min-h-screen relative flex flex-col items-center pt-8 pb-16 px-6 overflow-hidden">
        ...
        <nav className="w-full max-w-[1200px] mx-auto bg-transparent border border-[#18181A]/20 rounded-xl px-4 py-3 flex items-center justify-between relative z-50 shadow-sm">
          ...
          <div className="hidden md:flex items-center gap-6 text-[13px] font-medium text-[#18181A]">
            ...
            >
              Product <ChevronRight className="h-3 w-3 rotate-90 opacity-50" />
            </Link>
            <Link
              href="/product#individuals"
              className="hover:opacity-70 transition-opacity flex items-center gap-1"
            >
              Individuals{" "}
            ...
            <Link
              ...
              className="hover:opacity-70 transition-opacity flex items-center gap-1"
            >
              Company <ChevronRight className="h-3 w-3 rotate-90 opacity-50" />
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4 border-l border-[#18181A]/10 pl-8">
            <Link
              href="/login"
              className="text-[13px] font-bold text-[#18181A] hover:opacity-70 transition-opacity"
            >
              Log in
            </Link>
            <Link
              href="/session"
              className="bg-[#E9D5FF] border border-[#18181A] hover:bg-[#D8B4FE] text-[#18181A] px-5 py-2 rounded-lg text-[13px] font-bold transition-colors"
            >
              Live demo
            </Link>
          </div>
        ...
        <div className="text-center relative z-20 max-w-4xl mx-auto mt-24 flex flex-col items-center pb-32">
          ...
          <p className="mt-8 text-[18px] md:text-[22px] text-[#18181A]/60 max-w-2xl mx-auto leading-relaxed font-serif tracking-wide">
            The clinical AI that turns your patient consultations into{" "}
            <br className="hidden md:block" />
            <span className="text-[#18181A] font-medium">
              structured SOAP notes
            </span>{" "}
            and{" "}
            <span className="text-[#18181A] font-medium">
              ready-to-sign prescriptions.
            </span>
          </p>
          ...
          <div className="mt-10 flex items-center justify-center gap-4 z-30 relative pointer-events-auto">
            <Link
              href="/session"
              className="bg-[#E9D5FF] border border-[#18181A] hover:bg-[#D8B4FE] text-[#18181A] px-8 py-3.5 rounded-full text-[15px] font-bold transition-all hover:scale-105 shadow-sm inline-block"
            >
              Live demo
            </Link>
            <Link
              href="/dashboard"
              className="bg-[#FDFBF2] border border-[#18181A] hover:bg-[#18181A]/5 text-[#18181A] px-8 py-3.5 rounded-full text-[15px] font-bold transition-all hover:scale-105 shadow-sm inline-block"
            >
              Dashboard
            </Link>
          </div>
        ...
        <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
          ...
          >
            <defs>
              <path
                id="ribbonPath1"
                d="M -100 400 C 100 300, 150 200, 200 300 C 250 400, 100 500, -100 400"
              />
              <path
                id="ribbonPath2"
                d="M -10 500 Q 400 700 700 700 T 1500 550"
              />
            ...
            <text className="text-[15px] fill-[#18181A]/40 font-medium tracking-wide">
              <textPath href="#ribbonPath1" startOffset="0%">
                {Array(20)
                  .fill(
                    "patient presented with a mild cough and some fatigue over the last few days, going to handle the first part of the assessment was really good and I think their vitals are stable. ",
                  )
                  .join(" ")}
                <animate
            ...
            <path
              d="M 700 710 Q 1100 710 1500 560 L 1500 510 Q 1100 660 700 660 Z"
              fill="#18181A"
            />
              ...
              <div className="w-full h-full flex items-center justify-center pointer-events-auto">
                <div className="bg-[#FDFBF2] border border-[#18181A] px-4 py-2.5 rounded-full flex items-center shadow-md scale-90 md:scale-100">
                  ...
                  <div className="ml-2 flex gap-[2px] md:gap-[3px] h-3 md:h-4 items-center">
                    ...
                    <span
                      className="w-[1.5px] md:w-[2px] h-[100%] bg-[#18181A] rounded-full animate-pulse"
                      style={{ animationDelay: "0.2s" }}
                    ></span>
                    <span
                      className="w-[1.5px] md:w-[2px] h-[60%] bg-[#18181A] rounded-full animate-pulse"
                      style={{ animationDelay: "0.4s" }}
                    ></span>
                    <span
                      className="w-[1.5px] md:w-[2px] h-[80%] bg-[#18181A] rounded-full animate-pulse"
                      style={{ animationDelay: "0.1s" }}
                    ></span>
                    <span
                      className="w-[1.5px] md:w-[2px] h-[50%] bg-[#18181A] rounded-full animate-pulse"
                      style={{ animationDelay: "0.3s" }}
                    ></span>
                    <span
                      className="w-[1.5px] md:w-[2px] h-[90%] bg-[#18181A] rounded-full animate-pulse"
      ...
      <section className="bg-[#18181A] text-white py-32 px-6 rounded-t-[40px] md:rounded-t-[80px] -mt-10 relative z-20 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-white/20 text-[11px] font-bold uppercase tracking-widest mb-10">
            <span>Mac</span> <span className="opacity-40">•</span>{" "}
            <span>Windows</span> <span className="opacity-40">•</span>{" "}
            <span>iOS & Android</span>
          </div>

          <h2 className="font-serif text-[40px] md:text-[64px] leading-[1.1] tracking-tight mb-6">
            Seamlessly integrates with <br className="hidden md:block" /> your
            EHR, anywhere.
          </h2>
          <p className="text-[#FDFBF2]/60 text-base max-w-xl mx-auto">
            Universal compatibility across all major medical software. If you
            can click it, CuraLynx can type in it.
          </p>

          <div className="mt-10">
            <Link
              href="/integrations"
              className="bg-white hover:bg-zinc-200 text-[#18181A] px-6 py-3 rounded-full text-[13px] font-bold transition-colors"
            >
        ...
        <div className="mt-20 relative h-[300px] max-w-5xl mx-auto">
          ...
          {/* Floating 'Apps' */}
          <div className="absolute top-10 left-10 w-12 h-12 bg-blue-500 rounded-2xl rotate-[-10deg] flex items-center justify-center shadow-lg">
            <FileText className="text-white h-6 w-6" />
          </div>
          <div className="absolute top-20 right-20 w-16 h-16 bg-emerald-500 rounded-2xl rotate-[15deg] flex items-center justify-center shadow-lg">
            <Activity className="text-white h-8 w-8" />
          </div>
          <div className="absolute bottom-20 left-1/4 w-14 h-14 bg-red-500 rounded-3xl rotate-[5deg] flex items-center justify-center shadow-lg">
      ...
      <section className="bg-[#FDFBF2] py-32 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-[#18181A]/70 text-base max-w-2xl mx-auto mb-12">
            Stop sacrificing your evenings to catch up on charts. Our real-time
            AI structures the note while you speak, so you can lock the chart
          ...
          <div className="flex items-center justify-center gap-4 mb-16">
            <Link
              href="/demo"
              className="border border-[#18181A]/20 hover:bg-[#18181A]/5 text-[#18181A] px-6 py-3 rounded-full text-[13px] font-bold transition-colors flex items-center gap-2"
            >
              <Play className="h-4 w-4" /> Watch Demo
            </Link>
            <Link
              href="/session"
              className="bg-[#E9D5FF] hover:bg-[#D8B4FE] text-[#18181A] px-6 py-3 rounded-full text-[13px] font-bold transition-colors"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="relative w-full aspect-[16/9] md:aspect-[21/9] bg-zinc-100 rounded-3xl overflow-hidden shadow-2xl border border-[#18181A]/10">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-8 md:left-24 bg-white/90 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl border border-white flex flex-col items-center transform -rotate-2 hover:rotate-0 transition-transform">
              <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-wider mb-2">
                Manual Typing
              </span>
              <span className="text-4xl md:text-5xl font-serif text-[#18181A]">
                45 <span className="text-xl font-sans text-zinc-400">wpm</span>
              </span>
            </div>
            ...
            <div className="absolute top-1/2 -translate-y-1/2 right-8 md:right-24 bg-[#0B392A]/95 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl border border-[#0B392A]/40 flex flex-col items-center text-white transform rotate-2 hover:rotate-0 transition-transform">
              ...
              <span className="text-4xl md:text-6xl font-serif">
                150+{" "}
                <span className="text-xl font-sans text-emerald-200/50">
                  wpm
                </span>
              </span>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16 mb-32">
            <div className="flex-1">
              <h2 className="font-serif text-[48px] md:text-[64px] leading-[1.1] tracking-tight mb-6">
                ...
                <span className="italic text-[#E9D5FF]">you work</span>
              </h2>
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-4 py-2 rounded-full border border-white/10 text-xs font-semibold">
                  SOAP Notes
                </span>
                <span className="px-4 py-2 rounded-full border border-white/10 text-xs font-semibold">
                  Referrals
                ...
                <div className="flex items-center gap-4 mb-8 border-b border-white/10 pb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/40">
                      Listening... "Start Subjective"
                    </p>
                  </div>
                </div>
                <div className="space-y-6">
                  <div className="flex gap-4 items-start">
                    <span className="text-xs font-bold text-emerald-400 mt-1 shrink-0">
                      Dr. Chen
                    </span>
                    <p className="text-[13px] text-white/80 leading-relaxed bg-white/5 p-3 rounded-2xl rounded-tl-sm border border-white/5">
                      "Patient is a 45-year-old male presenting with acute lower
                      back pain radiating to the left leg, which started 3 days
                      ago after lifting heavy boxes."
                    </p>
                  </div>
                  <div className="flex gap-4 items-start flex-row-reverse">
                    <span className="text-xs font-bold text-blue-400 mt-1 shrink-0">
                      Patient
                    </span>
                    <p className="text-[13px] text-white/80 leading-relaxed bg-blue-500/10 p-3 rounded-2xl rounded-tr-sm border border-blue-500/20 text-right">
                      "Yeah, it’s mostly a sharp pain, and it hurts a lot when I
                      try to bend over or sit for too long."
                    </p>
                  </div>
                  <div className="flex gap-4 items-start">
                    <span className="text-xs font-bold text-emerald-400 mt-1 shrink-0">
          ...
          <div className="grid md:grid-cols-2 gap-x-12 gap-y-24">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-full aspect-[4/3] bg-[#FDFBF2] rounded-3xl mb-8 overflow-hidden relative border border-white/10 flex items-center justify-center p-8">
                ...
                <div className="bg-white rounded-xl shadow-xl w-full h-full p-6 flex flex-col border border-[#18181A]/10 text-left relative overflow-hidden">
                  <div className="flex justify-between items-center mb-6">
                    <h4 className="font-bold text-[#18181A] text-sm">
                      SOAP Note
                    </h4>
                  ...
                  <div className="space-y-4 mb-auto">
                    <div>
                      <h5 className="text-[11px] font-bold text-[#18181A]/50 uppercase tracking-wider mb-1.5 flex items-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500"></div>{" "}
                        Subjective
                      </h5>
                      <p className="text-[13px] text-[#18181A]/80 font-medium leading-snug">
                        45yo male c/o acute lower back pain radiating to L leg x
                        3 days. Exacerbated by bending/sitting. No hx of trauma.
                      </p>
                    </div>
                    <div>
                      <h5 className="text-[11px] font-bold text-[#18181A]/50 uppercase tracking-wider mb-1.5 flex items-center gap-2">
                      ...
                      <p className="text-[13px] text-[#18181A]/80 font-medium leading-snug">
                        Pending physical exam. Vitals within normal limits.
                        Patient appears uncomfortable sitting.
                      </p>
                    </div>
                  </div>
                  <div className="bg-gradient-to-r from-[#E9D5FF]/30 to-transparent text-[#18181A] text-[11px] font-bold p-3 rounded-xl border border-[#E9D5FF] mt-4 flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-purple-600" /> Formatted
                    in 1.2s
                  </div>
                </div>
              </div>
              ...
              <p className="text-white/60 text-sm max-w-sm">
                Never manually categorize subjective vs objective again. Our NLP
                engine perfectly structures the conversation.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:mt-24">
              <div className="w-full aspect-[4/3] bg-[#0B392A] rounded-3xl mb-8 overflow-hidden relative border border-white/10 flex items-center justify-center p-8">
                ...
                <div className="bg-[#18181A] rounded-xl shadow-xl w-full h-full p-6 flex flex-col gap-3 relative">
                  <span className="text-xs font-bold text-white/50 text-left mb-2">
                    Medical Vocabulary
                  </span>
                  <div className="bg-white/5 p-3 rounded-lg text-left text-xs font-medium text-emerald-400">
                    Echocardiogram shows EF 55%
                  </div>
                  <div className="bg-white/5 p-3 rounded-lg text-left text-xs font-medium text-emerald-400">
                    Patient prescribed Lisinopril 10mg
                  </div>
                  <div className="bg-white/5 p-3 rounded-lg text-left text-xs font-medium text-emerald-400">
              ...
              <p className="text-white/60 text-sm max-w-sm">
                Pre-trained on billions of clinical data points to understand
                complex medical terminology flawlessly.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-full aspect-[4/3] bg-[#212124] rounded-3xl mb-8 overflow-hidden relative border border-white/10 flex items-center justify-center p-8">
                ...
                <div className="bg-[#18181A] rounded-xl shadow-2xl w-full h-full p-6 flex flex-col relative border border-white/10 text-left overflow-hidden">
                  <div className="absolute top-4 right-4 text-[60px] font-serif text-white/5 opacity-50 select-none pointer-events-none">
                    Rx
                  </div>
                  ...
                  <div className="bg-white/5 p-4 rounded-xl border border-white/10 mb-auto relative">
                    ...
                    <div className="flex justify-between items-start mb-2 pl-2">
                      ...
                      <span className="text-[10px] bg-white/10 px-2 py-1 rounded text-white/70 font-bold">
                        10mg
                      </span>
                    </div>
                    <p className="text-[11px] text-white/60 mb-3 pl-2">
                      Take 1 tablet by mouth daily for hypertension.
                    </p>
                  ...
                  <Link
                    href="/session"
                    className="w-full py-3 bg-emerald-500/20 text-emerald-400 text-[11px] font-bold uppercase tracking-wider rounded-lg hover:bg-emerald-500/30 transition-colors border border-emerald-500/20 mt-4 text-center"
                  >
                    E-Prescribe
                  </Link>
                </div>
              ...
              <p className="text-white/60 text-sm max-w-sm">
                Automatically extract medication mentions and format them into
                ready-to-review prescriptions.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center md:mt-24">
              <div className="w-full aspect-[4/3] bg-gradient-to-br from-indigo-900 to-[#18181A] rounded-3xl mb-8 overflow-hidden relative border border-white/10 flex items-center justify-center p-8">
                ...
                <div className="w-full h-full flex flex-col justify-center gap-4 relative z-10">
                  <div className="flex flex-col bg-white/10 backdrop-blur rounded-xl p-4 border border-white/10">
                    <span className="text-[10px] font-bold text-white/50 uppercase tracking-wider mb-2 text-left">
                      Spanish (Patient)
                    </span>
                    <p className="text-sm text-white/90 text-left font-medium">
                      "Me duele mucho la cabeza y siento náuseas desde ayer."
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col bg-indigo-500/20 backdrop-blur rounded-xl p-4 border border-indigo-400/30">
                    <span className="text-[10px] font-bold text-indigo-300 uppercase tracking-wider mb-2 text-left">
                      English (Clinical Note)
                    </span>
                    <p className="text-sm text-indigo-100 text-left font-medium">
                      Patient reports severe headache and nausea starting
                      yesterday.
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none">
                  <span className="font-serif text-[180px] text-white font-bold leading-none">
                    15+
                  </span>
                </div>
              </div>
              ...
              <p className="text-white/60 text-sm max-w-sm">
                Conduct consultations in Spanish, Hindi, or Mandarin, and
                instantly generate English clinical notes.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#E9D5FF] py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto flex flex-col items-center">
          <div className="flex gap-4 mb-6 opacity-60 text-[#18181A]">
            ...
            <div className="h-10 w-10 bg-[#18181A] rounded-lg text-white flex items-center justify-center text-xs font-bold">
              Mac
            </div>
            <div className="h-10 w-10 bg-[#18181A] rounded-lg text-white flex items-center justify-center text-xs font-bold">
              Win
          ...
          <p className="text-[#18181A]/60 text-sm max-w-md mx-auto mb-8">
            Download the desktop app for deep EHR integration, or use the mobile
            app for ward rounds and on-the-go dictation.
          </p>
          <Link
            href="/download"
            className="bg-transparent border border-[#18181A] hover:bg-[#18181A] hover:text-white text-[#18181A] px-8 py-3 rounded-full text-[13px] font-bold transition-all"
          >
            Download now
          </Link>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col">
              <p className="font-serif text-lg text-white/90 leading-relaxed mb-8 flex-1">
                "It’s completely changed how I interact with patients. I make
                eye contact now instead of staring at my screen. The notes are
                drafted perfectly by the time they leave."
              </p>
            ...
            <div className="bg-[#FDFBF2] text-[#18181A] rounded-3xl p-8 flex flex-col md:-translate-y-4 shadow-xl">
              <p className="font-serif text-lg leading-relaxed mb-8 flex-1">
                "The accuracy on complex oncology terminology is astounding. It
                saves me about 2 hours of charting every single day. I couldn't
                go back to normal typing."
              </p>
              <div className="flex items-center gap-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col">
              <p className="font-serif text-lg text-white/90 leading-relaxed mb-8 flex-1">
                "Perfect for fast-paced urgent care. The bilingual feature alone
                is worth it—translating Spanish consultations into English SOAP
                notes instantly is magic."
              </p>
              <div className="flex items-center gap-4">
      ...
      <section className="relative py-40 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center text-white">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link
              href="/session"
              className="bg-[#E9D5FF] hover:bg-[#D8B4FE] text-[#18181A] px-8 py-4 rounded-full text-[15px] font-bold transition-all shadow-lg"
            >
              Try CuraLynx free
            </Link>
            <Link
              href="/demo"
              className="bg-white/10 backdrop-blur border border-white/20 hover:bg-white/20 text-white px-8 py-4 rounded-full text-[15px] font-bold transition-all shadow-lg"
            >
              Book a Demo
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 text-[13px]">
            <div>
              ...
              <ul className="space-y-3 text-[#18181A]/60">
                ...
                <li>
                  <Link href="/company#security">Security & HIPAA</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-[#18181A]/60">
                ...
                <li>
                  <Link href="/integrations">Supported EHRs</Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-[#18181A]/60">
                <li>
                  <Link href="/resources#help">Help Center</Link>
                </li>
                <li>
                  <Link href="/resources#case-studies">Case Studies</Link>
                </li>
                <li>
                  <Link href="/resources#api">API Docs</Link>
                </li>
                <li>
